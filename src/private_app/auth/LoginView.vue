      ...
      <form class="space-y-6" @submit.prevent="handleLogin">
        <div>
          ...
          <div class="mt-2">
            <input 
              ...
              id="username" 
              required
              class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#FFA800] sm:text-sm/6"
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-gray-600 hover:text-gray-500">Olvidó su password?</a>
            </div>
          </div>
          <div class="mt-2">
            <input 
        ...
        <div>
          <button 
            type="submit" 
            class="flex w-full justify-center rounded-md bg-[#FFA800] px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-[#E69500] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFA800]"
            :disabled="isLoading"
          >
