...
import MobileTabSelector from '@/private_app/turnos/components/MobileTabSelector.vue'
import DesktopTabNavigation from '@/private_app/turnos/components/DesktopTabNavigation.vue'
import ActionButtons from '@/private_app/turnos/components/ActionButtons.vue'
import LoadingSpinner from '@/shared/components/common/LoadingSpinner.vue'
import VentanillaForm from '@/private_app/turnos/views/tabs/VentanillaForm.vue'
import FormularioForm from '@/private_app/turnos/views/tabs/FormularioForm.vue'
import DocumentacionForm from '@/private_app/turnos/views/tabs/DocumentacionForm.vue'
import NotasForm from '@/private_app/turnos/views/tabs/NotasForm.vue'
import PreliquidacionForm from '@/private_app/turnos/views/tabs/PreliquidacionForm.vue'
import SupervisionForm from '@/private_app/turnos/views/tabs/SupervisionForm.vue'
import PreradicacionForm from '@/private_app/turnos/views/tabs/PreradicacionForm.vue'
