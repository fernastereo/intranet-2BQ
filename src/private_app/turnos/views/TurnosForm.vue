...
import MobileTabSelector from '@/private_app/turnos/shared/components/MobileTabSelector.vue'
import DesktopTabNavigation from '@/private_app/turnos/shared/components/DesktopTabNavigation.vue'
import ActionButtons from '@/private_app/turnos/shared/components/ActionButtons.vue'
import LoadingSpinner from '@/shared/components/common/LoadingSpinner.vue'
import VentanillaForm from '@/private_app/turnos/components/VentanillaForm.vue'
import FormularioForm from '@/private_app/turnos/components/FormularioForm.vue'
import DocumentacionForm from '@/private_app/turnos/components/DocumentacionForm.vue'
import NotasForm from '@/private_app/turnos/components/NotasForm.vue'
import PreliquidacionForm from '@/private_app/turnos/components/PreliquidacionForm.vue'
import SupervisionForm from '@/private_app/turnos/components/SupervisionForm.vue'
import PreradicacionForm from '@/private_app/turnos/components/PreradicacionForm.vue'
